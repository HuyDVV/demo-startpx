...
const { values, setFieldValue, validate } = useForm<SignInModel>({
  ...
  initialValues: { username: 'hendrik@starpx.com', password: 'StarpxStarpx1!' }
})
...
<template>
  <div class="flex h-screen items-center justify-center">
    ...
    <div class="bg-forth bg-opacity-50 rounded-lg flex flex-col items-center justify-center relative h-[500px] p-10 gap-8 min-w-[500px]">
      <!-- header -->
      ...
      <div class="flex flex-col gap-3 w-5/6">
        <div class="flex flex-col gap-2">
          <span class="text-md font-bold text-zinc-100">Username</span>
          <StarpxInput
        ...
        <div class="flex flex-col gap-2">
          <span class="text-md font-bold text-zinc-100">Password</span>
          <StarpxInput
